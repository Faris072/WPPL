...
<body class="img" style="background-image: url(/storage/default/bg.jpg); height: 100vh;">
    ...
    @if (session()->has('pesan'))
        <script>
            swal("Register gagal!", "{{ session('pesan') }}", "error");
        </script>
    @endif
                        ...
                        <form action="/register" method="POST" class="signin-form">
                            ...
                            <div class="form-group">
                                <input id="password" type="password" name="password"
                                    ...
                                    required>
                                <span toggle="#password-field" id="mata"
                            ...
                            <div class="form-group">
                                ...
                                <span toggle="#password-field" id="mata2"
                                    class="fa fa-fw fa-eye field-icon toggle-password"></span>
                                <small style="color:white;">
                                    @error('password2')
                                        {{ $message }}
                            ...
                            <div class="form-group">
                                <button type="submit" name="submit" value="Buat akun"
